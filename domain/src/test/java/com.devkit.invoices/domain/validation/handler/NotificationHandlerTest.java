package com.devkit.invoices.domain.validation.handler;
...
import com.devkit.invoices.domain.validation.Validator;
...
class NotificationHandlerTest extends UnitTest {
    ...
    void givenAValidValidation_whenCallValidate_thenShouldThrowsException() {
        final var expectedErrorMessage = "Cannot invoke \"com.devkit.invoices.domain.validation.ValidationHandler$Validation.validate()\" because \"aValidation\" is null";
        NotificationHandler handler = NotificationHandler.create();
